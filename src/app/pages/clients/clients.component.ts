...
clients: Client[] = [
  ...
  },
  {
    ...
    industry: 'Automotive',
    logo: '🚗',
    logoPath: 'assets/logos/sona-blw-logo.png',
...
testimonials: Testimonial[] = [
  {
    name: 'Hindustan Syringes & Medical Devices (HMD)',
    position: '',
    company: 'Hindustan Syringes & Medical Devices (HMD)',
    text: 'AN NextGen Innovations delivered a highly reliable AI-based vision inspection system that significantly strengthened our quality control process. Manual inspection dependency was reduced while maintaining very high accuracy levels. Their understanding of medical device manufacturing and compliance requirements is strong.',
    rating: 5
  },
  {
    name: 'SONA BLW Precision Forgings',
